...
`finding_donors.ipynb` notebook file is the code for the project. also, `visuals.py` Python file and the `census.csv` dataset file are required for executing the code. 
